...
//------------------------------------------------------------
		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/payment/fondy_bank', 'token=' . $this->session->data['token'], 'SSL'),      		
      		'separator' => ' :: '
   		);
				
		$data['action'] = $this->url->link('extension/payment/fondy_bank', 'token=' . $this->session->data['token'], 'SSL');
...
//------------------------------------------------------------
		...
		$arr = array( "fondy_bank_merchant", "fondy_bank_secretkey", "fondy_bank_backref", "fondy_bank_server_back","fondy_bank_order_cancelled_status_id",
            "fondy_bank_language", "fondy_bank_status", "fondy_bank_sort_order", "fondy_bank_order_status_id", "fondy_bank_order_process_status_id", "fondy_bank_currency", "fondy_bank_styles");
...
//------------------------------------------------------------
		...
		$this->response->setOutput($this->load->view('extension/payment/fondy_bank.tpl', $data));
	}
//------------------------------------------------------------
