...
{
    private $error = [];
    private $extensionVersion = '2.0.0';
    ...
    public function index()
    {
        ...
        $data['action'] = $this->url->link('extension/payment/oplata', 'token=' . $this->session->data['token'], true);
    ...
    private function getBreadcrumbs()
    {
        return [
            ...
            [
                ...
                'href' => $this->url->link('extension/payment/oplata', 'token=' . $this->session->data['token'], true),
                'separator' => ' :: '
            ],
        ];
    }
