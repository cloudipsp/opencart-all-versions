...
//------------------------------------------------------------
		...
		#$this->data['LUURL'] = "index.php?route=payment/fondy_bank/callback";
...
//------------------------------------------------------------
		...
		$this->data['action'] = $this->url->link('payment/fondy_bank', 'token=' . $this->session->data['token'], 'SSL');
...
//------------------------------------------------------------
		...
		$this->data['fondy_bank_currencyc']= array('EUR','USD','GBP','RUB','UAH');
		$arr = array( "fondy_bank_merchant", "fondy_bank_secretkey", "fondy_bank_currency", "fondy_bank_backref", "fondy_bank_server_back",
            "fondy_bank_language", "fondy_bank_status", "fondy_bank_sort_order", "fondy_bank_order_status_id", "fondy_bank_order_process_status_id", "fondy_bank_order_cancelled_status_id" );
...
//------------------------------------------------------------
		...
		$this->template = 'payment/fondy_bank.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
